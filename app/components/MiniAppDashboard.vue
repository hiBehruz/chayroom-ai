...
<template>
  <div class="flex justify-center items-start" style="background:#17212b; min-height:100vh">
    ...
    >
      ...
      <div class="mb-7">
        ...
        <div class="flex gap-3 px-4 overflow-x-auto pb-1" style="scrollbar-width:none; -ms-overflow-style:none">
          ...
          <div
            ...
            style="background:linear-gradient(135deg,#2d6a4f,#1b4332); width:140px; min-height:168px; box-shadow:0 8px 32px rgba(29,99,66,0.4)"
          >
            <div>
          ...
          <div
            ...
            :key="task.id"
            class="flex-none rounded-2xl p-4 flex flex-col justify-between"
            :style="`background:${task.gradient}; width:116px; min-height:168px; box-shadow:0 8px 24px rgba(0,0,0,0.3)`"
          >
      ...
      <!-- Bottom Nav -->
      <div
        class="fixed bottom-0 left-1/2 -translate-x-1/2 w-full flex items-center justify-around py-1 z-50 backdrop-blur-md"
        style="max-width:390px; background:rgba(23,33,43,0.96); border-top:1px solid #2b3a4a"
      >
        <NuxtLink
          to="/dashboard"
          class="flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl active:opacity-60 transition-opacity"
          style="color:#5288c1"
        >
