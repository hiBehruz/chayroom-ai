...
const { data: guidesData } = useAsyncData<MiniGuide[]>('dash-guides', () => $fetch('/api/guides', { query: { limit: 5 } }))
const { data: coursesData } = useAsyncData<MiniCourse[]>('dash-courses', () => $fetch('/api/courses', { query: { limit: 3 } }))
...
<template>
  ...
  >
    ...
    <template v-if="!hasSubscription">
      <div
        class="flex flex-col px-[18px] pt-10 pb-6"
      ...
      >
        ...
        <div
          ...
          style="background:#ffffff;border-radius:22px;padding:20px;border:1.5px solid #e5e7eb"
        >
          ...
          <p style="font-size:11px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#9aa0a8;margin:0 0 6px">
            Yillik obuna
          </p>
        ...
        >
          ...
          >
            <span
              class="size-3.5 rounded-full border-2 inline-block"
              style="border-color:#e5e7eb;border-top-color:#374151;animation:spin 0.8s linear infinite"
            />
            Tekshirilmoqda...
          </span>
          <span
            v-else-if="checked"
            style="color:#ef4444"
          >To'lov topilmadi. Qayta urinib ko'ring.</span>
    ...
    <template v-else>
      ...
      <div style="padding:16px 18px 18px">
        ...
        <div style="font-size:13px;color:#6b7280;font-weight:500;margin-top:3px">
          Daraja oshir
        </div>
      </div>
      ...
      <div class="mb-5">
        ...
        >
          <h2 style="font-size:22px;font-weight:800;letter-spacing:-0.025em;color:#0f1115;margin:0">
            Vazifalar
          </h2>
        ...
        <div
          ...
          style="padding:12px 18px 22px;scroll-padding-inline:18px;scroll-snap-type:x mandatory;scrollbar-width:none;-ms-overflow-style:none"
        >
          <!-- Dark progress card -->
          <NuxtLink
            to="/mini/tasks"
          ...
          >
            ...
            <div>
              <p style="font-size:16px;font-weight:800;letter-spacing:-0.015em;line-height:1.1;margin:0 0 12px;color:#0f1115;white-space:pre-line">
                {{ task.label }}
              </p>
              <div class="flex items-center justify-between">
                <div
                  v-if="task.done"
                  style="width:24px;height:24px;border-radius:50%;background:#0f1115;display:grid;place-items:center"
                >
                  <svg
                    width="11"
                    height="11"
      ...
      <div
        ...
        style="padding:0 18px"
      >
        <h2 style="font-size:22px;font-weight:800;letter-spacing:-0.025em;color:#0f1115;margin:0 0 12px">
          Davom etish
        </h2>
        <NuxtLink
      ...
      <div style="padding:8px 18px 24px">
        ...
        <!-- Skeleton -->
        <div
          v-if="!freshItems.length && !guidesData && !coursesData"
        ...
        >
          ...
          >
            ...
            <div class="flex-1 flex flex-col gap-2">
              <div
                class="skeleton"
                style="height:10px;width:30%;border-radius:6px"
              />
              <div
                class="skeleton"
                style="height:14px;width:75%;border-radius:6px"
              />
            </div>
          </div>
        </div>
