...
<span
        ...
        >
          ...
          <p class="text-[17px] text-cx-muted leading-[1.6] max-w-[380px] mb-6">
            Оформите подписку Chayroom AI Club, чтобы получить доступ к этому и другим материалам
          </p>
          <button
            class="btn-primary btn-primary-dark px-8 py-3 text-[17px]! mb-3"
          ...
          <NuxtLink
            to="/login"
            class="text-[15px] text-cx-muted hover:text-cx-ink transition-colors"
          >
