...
<template>
  <div style="background:#fffdf9; min-height:100vh">
    <div class="w-full">
      ...
      <!-- Hero card -->
      <div
        class="mx-4 mb-5 rounded-[20px] overflow-hidden"
      ...
      >
        ...
        <div class="p-5">
          <div
            ...
            style="background:rgba(52,128,241,0.1);border:1px solid rgba(52,128,241,0.2)"
          >
            <svg
          ...
          <h1
            class="text-[28px] font-black tracking-tight leading-tight mb-3"
            style="color:#0f1115"
          >
            AI Room Club
          </h1>
          ...
          <p
            class="text-[14px] leading-relaxed mb-5"
            style="color:#6b7280"
          >
      ...
      <div class="px-4 mb-5">
        ...
        <div class="space-y-2.5">
          ...
          >
            <div
              class="size-9 rounded-xl flex-none flex items-center justify-center mt-0.5"
        ...
        <p
          class="text-[12px] text-center mt-3 leading-relaxed"
          style="color:#9aa0a8"
        >
      ...
      <div class="px-4 mb-5">
        ...
        <div class="grid grid-cols-2 gap-2.5">
          ...
          >
            ...
            >Tez kunda</span>
            <div
              class="size-10 rounded-xl flex items-center justify-center mb-3"
            ...
            <p
              class="text-[13px] font-bold mb-1"
              style="color:#0f1115"
            >
              {{ item.title }}
            </p>
