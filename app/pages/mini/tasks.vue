...
const tasks = [
  { id: 'about', label: 'Про наше сообщество', icon: 'noto:open-book', done: true, link: '/mini/about' },
  { id: 'rules', label: 'Наши правила', icon: 'noto:memo', done: true, link: '/mini/rules' },
  { id: 'intro', label: 'Расскажите о себе', icon: 'noto:potted-plant', done: true, link: '/mini/intro' },
  { id: 'first', label: 'Первый материал', icon: 'noto:sparkles', done: true, link: null },
]
    ...
    <div class="w-full">
      ...
      <div class="flex items-center gap-3 px-4 pt-5 pb-4">
        <button
          ...
          style="width:44px;height:44px;border-radius:999px;background:#e5e5e5;color:#14161f"
          @click="router.back()"
        >
          <UIcon name="i-lucide-arrow-left" class="size-4.5" />
        </button>
        <h1 class="text-[26px] font-black tracking-tight leading-tight" style="color:#14161f">Задания</h1>
      </div>

      <!-- Progress card -->
      <div class="px-4 mb-5">
        <div class="rounded-[24px] p-7" style="background:#3480f1">
          <p class="text-[10px] font-black tracking-widest uppercase mb-2" style="color:rgba(255,255,255,0.6)">ПРОГРЕСС</p>
          ...
          <p class="text-[13px] font-semibold" style="color:rgba(255,255,255,0.75)">ЗАВЕРШЁННЫЕ</p>
      ...
      <div class="px-4 space-y-2">
        ...
        >
          ...
          <span class="flex-1 text-[15px] font-semibold leading-snug" style="color:#14161f">{{ task.label }}</span>
          <div class="flex items-center gap-2 flex-none">
            ...
            <span v-if="task.link" style="color:#c0c0c8; font-size:18px">›</span>
          </div>
        </component>
      </div>
