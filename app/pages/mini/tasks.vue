...
<template>
  <div style="background:#fffdf9; min-height:100vh">
    <div class="w-full pb-28">
      ...
      <div class="px-4 mb-5">
        <div
          class="rounded-[24px] p-7"
          style="background:linear-gradient(135deg,#3480f1,#6c63ff)"
        >
          <p
            class="text-[10px] font-black tracking-widest uppercase mb-2"
            style="color:rgba(255,255,255,0.6)"
          >
            PROGRESS
          </p>
          <p
            class="font-black leading-none mb-1.5"
          ...
          <div
            class="mt-5 rounded-full overflow-hidden"
            style="height:5px;background:rgba(255,255,255,0.2)"
          >
            <div
      ...
      <div class="px-4 space-y-2">
        ...
        >
          ...
          />
          <span
            class="flex-1 text-[15px] font-semibold leading-snug"
            style="color:#0f1115"
          >{{ task.label }}</span>
          <div class="flex items-center gap-2 flex-none">
            ...
            <span
              v-if="task.link"
              style="color:#c4c8d2; font-size:18px"
            >›</span>
          </div>
        </component>
      </div>
